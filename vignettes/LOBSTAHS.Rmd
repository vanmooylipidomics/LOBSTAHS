...
<span id="How-calc-base-fragment">The user should then define the mass of a "base fragment" upon which the `generateLOBdbase()` function will perform iteration.</span> The base fragment should include the glycerol backbone, any carboxylic oxygen atoms in the fatty acid(s), and (if applicable), the entire lipid headgroup.
